...
function Quiz(props) {
  ...
  // 1st argument - a function that we want to run at a certain time
  // 2nd argument - an array of things we're watching for changes and then we run the function (1st arg) in response
  useEffect(() => {
    if (isCorrect === false) {
      setTimeout(() => {
